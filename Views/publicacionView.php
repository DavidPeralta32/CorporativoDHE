...
<body>
    <div class="contenedor">
        ...
        <div class="btnAgregarPubicacion">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-focus="true" data-bs-target="#ModalAgregarPublicacion" data-bs-backdrop="static" data-keyboard="false">
                Agregar
            </button>
        </div>
        <!-----------------------------------------------TABLA ARTICULOS----------------------------------------------------------------->
    ...
    <div class="modal fade" id="ModalEditarPublicacion" data-bs-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="ModalAgregarPublicacion" data-bs-backdrop="static"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body-editar sContenidoModal" style="padding: 10px;">
                    <textarea id="sAgregarPublicacion" cols="50" rows="10"></textarea>
                </div>
                <div class="modal-footer" style="display: flex; flex-wrap: wrap; justify-content: space-between;">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal" onclick="limpiarEditor();">Cancelar</button>
